...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'installer.package_info': { zh: '包体信息', en: 'Package Info' },
  'installer.parsing': { zh: '解析中...', en: 'Parsing...' },

  // Package Info Dialog
  'pkginfo.title': { zh: '包体信息', en: 'Package Info' },
  'pkginfo.basic': { zh: '基础信息', en: 'Basic Info' },
  'pkginfo.file_name': { zh: '文件名', en: 'File Name' },
  'pkginfo.file_size': { zh: '文件大小', en: 'File Size' },
  'pkginfo.file_type': { zh: '文件类型', en: 'File Type' },
  'pkginfo.package_name': { zh: '包名', en: 'Package Name' },
  'pkginfo.version_name': { zh: '版本名', en: 'Version Name' },
  'pkginfo.version_code': { zh: '版本号', en: 'Version Code' },
  'pkginfo.min_sdk': { zh: '最低 SDK', en: 'Min SDK' },
  'pkginfo.target_sdk': { zh: '目标 SDK', en: 'Target SDK' },
  'pkginfo.compile_sdk': { zh: '编译 SDK', en: 'Compile SDK' },
  'pkginfo.debuggable': { zh: '可调试', en: 'Debuggable' },
  'pkginfo.allow_backup': { zh: '允许备份', en: 'Allow Backup' },
  'pkginfo.yes': { zh: '是', en: 'Yes' },
  'pkginfo.no': { zh: '否', en: 'No' },
  'pkginfo.structure': { zh: '包体结构', en: 'Package Structure' },
  'pkginfo.dex_count': { zh: 'DEX 文件数', en: 'DEX Files' },
  'pkginfo.has_assets': { zh: '包含 Assets', en: 'Has Assets' },
  'pkginfo.has_resources': { zh: '包含 Resources', en: 'Has Resources' },
  'pkginfo.uncompressed_size': { zh: '解压后大小', en: 'Uncompressed Size' },
  'pkginfo.architectures': { zh: 'CPU 架构', en: 'Architectures' },
  'pkginfo.native_libs': { zh: 'Native 库', en: 'Native Libraries' },
  'pkginfo.permissions': { zh: '权限列表', en: 'Permissions' },
  'pkginfo.no_permissions': { zh: '无权限声明', en: 'No permissions declared' },
  'pkginfo.signing': { zh: '签名信息', en: 'Signing Info' },
  'pkginfo.no_signing': { zh: '未检测到签名信息', en: 'No signing info detected' },
  'pkginfo.owner': { zh: '持有者', en: 'Owner' },
  'pkginfo.issuer': { zh: '颁发者', en: 'Issuer' },
  'pkginfo.serial': { zh: '序列号', en: 'Serial Number' },
  'pkginfo.valid_from': { zh: '有效期起', en: 'Valid From' },
  'pkginfo.valid_to': { zh: '有效期止', en: 'Valid To' },
  'pkginfo.algorithm': { zh: '签名算法', en: 'Algorithm' },
  'pkginfo.copy': { zh: '复制', en: 'Copy' },
  'pkginfo.copied': { zh: '已复制', en: 'Copied' },
  'pkginfo.parse_error': { zh: '解析失败', en: 'Parse Failed' },
